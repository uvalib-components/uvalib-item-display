...
`http://localhost:8080/components/uvalib-item-display/`, where `uvalib-item-display` is the name of the directory containing it.


## Testing Your Element

Simply navigate to the `/test` directory of your element to run its tests. If
you are using Polyserve: `http://localhost:8080/components/uvalib-item-display/test/`
